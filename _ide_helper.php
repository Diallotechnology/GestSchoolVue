...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
         ...
         * @static
         */
        public static function dateRange($requestOrStart, $end = null, $column = 'created_at')
        {
            return \Illuminate\Database\Eloquent\Builder::dateRange($requestOrStart, $end, $column);
        }
